...
if __name__ == '__main__':
    ...
    compute_and_visualize_transfer(content_path = 'The_Great_Wave_off_Kanagawa.jpg', style_path = '/content/Welle 2.jpg', style_weight=0.01)
    # here we try to make a portrait painting more realistic by using a portrait photograph as style image
    compute_and_visualize_transfer(content_path = '/content/Van Gogh Portrait.jpg', style_path = '/content/Van Gogh Lookalike.jpg', style_weight=0.001)